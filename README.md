...
- [x] ~~Додав відображення записів на календарі~~
- [x] ~~Додав відображення імен клієнтів в записах на календарі~~
- [x] ~~Додав планування існуючого клієнта~~
- [x] ~~Додай час прийому на календар~~
- [x] ~~Пофіксь статистику~~
- [x] ~~Зафіксив баг з getDoctorById~~
- [x] ~~Додав нових лікарів~~
- [x] ~~Редірект після створення клієнту на його картку~~
- [x] ~~Конфірм на видалення клієнту~~
- [x] ~~Баг з датою при додаванні клієнта 23/09/2009~~
- [x] ~~Додав відображення помилок валідації при додаванні нового клієнту~~
- [x] ~~Локалізував календар на російську мову~~
- [x] ~~Додай по батькові~~
- [x] ~~Локалізувати календарь на додаванні клієнта~~
- [x] ~~Перехід з календаря на картку клієнта~~
- [x] ~~Зафіксити баг з таймзоною при плануванні клієнту~~
- [x] ~~Локалізувати календарь на плануванні клієнта~~
- [x] ~~Додай колір лікаря на таймлайн~~
- [x] ~~Додай Lodash~~
- [x] ~~Додай колір лікаря на календар~~
- [x] ~~Пофіксив респонсів - виніс менюшку, додав іконки~~
- [x] ~~Зафіксив баг - що не зберігався коммент клієнта~~
- [x] ~~Зафіксив баг - що не зберігалось по батькові клієнта~~
- [x] ~~Додав редагування та видалення подій з історії~~
- [x] ~~Додав перезід з календаря на едіт події~~
- [x] ~~Поправити дизайн кількості в календарі~~
- [x] ~~Переніс календар з інпутів на іконку~~
- [x] ~~При редагуванні історії створюється дублюючий запис~~
- [x] ~~Додав запис, редагування та видалення подій для анонімного клієнту~~
- [x]  Змінив порядок імені в календарі
